...
DEFAULT_FRONTEND_ORIGINS = [FRONTEND_ORIGIN, "http://127.0.0.1:3000", "https://*.vercel.app"]
DEFAULT_CORS_ORIGIN_REGEXES = [r"^https://.*\.vercel\.app$"]
...
CSRF_TRUSTED_ORIGINS = env_list("CSRF_TRUSTED_ORIGINS", ",".join(DEFAULT_FRONTEND_ORIGINS))
